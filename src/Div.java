    ...
    public final Node crearQ() {
        ...
        while (i < numbers.length){
            ...
            if (n % 2 == 0){
             ...
             // Evitar 0 y generar números entre 1 y 10
        }
        i = 1;
        while (i < numbers.length){
            int n = random.nextInt(numbers[i-1]) + 2;
            if (numbers[i-1] % n == 0){
                numbers[i] = n;
                i+=2;
            }
...
//    
    ...
    private void initComponents() {
        ...
        Fondo.add(Res, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 230, 160, 60));
        ...
        c5.setOpaque(true);
        Fondo.add(c5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 120, 90, 60));
        ...
        c4.setOpaque(true);
        Fondo.add(c4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 180, 80, 60));
        ...
        c3.setOpaque(true);
        Fondo.add(c3, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 200, 80, 60));
        ...
        c2.setOpaque(true);
        Fondo.add(c2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 210, 80, 60));
        ...
        c1.setOpaque(true);
        Fondo.add(c1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 270, 70, 70));
        ...
        Fondo.add(P, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 350, 90, 80));
        ...
        Fondo.add(n1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, 60, 70));

        Menos.setFont(new java.awt.Font("Forte", 0, 48)); // NOI18N
        ...
        Fondo.add(n2, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 110, 60, 70));
        ...
        Fondo.add(Raya, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 170, 230, 10));
        ...
        Fondo.add(o3, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 120, 60, 40));
        ...
        Fondo.add(o1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 120, 60, 40));
        ...
        Fondo.add(o2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 170, 60, 40));
